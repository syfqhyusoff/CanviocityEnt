<%-- 
    Document   : update
    Created on : Apr 17, 2018, 9:45:39 PM
    Author     : Ikhwan Faris
--%>
...
<head>
	...
	<title>Canviocity | Update Profile </title>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="updateprofile.jsp" onsubmit="alert('You are updating your profile! Please wait');" >
                                    <div class="row">
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                  <input type="email" class="form-control" placeholder="New Email" name="newemail" value="<%=email1%>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                 <input type="text" class="form-control" placeholder="New Name" name="newname" value="<%=name1%>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                 <input type="number" class="form-control" placeholder="New Phone Number" name="newnum" value="<%=phone1%>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <br>
                                                 <input type="text" class="form-control" placeholder="New Address" name="newaddress" value="<%=address1%>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>City</label>
                                                <br>
                                                 <input type="text" class="form-control" placeholder="New City" name="newcity" value="<%=city1%>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>State</label>
                                                <br>
                                                 <input type="text" class="form-control" placeholder="New State" name="newstate" value="<%=Negeri1%>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                 <input type="number" class="form-control" placeholder="New Postal Code" name="newpostal" value="<%=postcode1%>">
                                            </div>
                                        </div>
                                    </div>
