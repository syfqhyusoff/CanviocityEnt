...
public class CoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("month")!=null){
            ...
            try{//T1
             conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+"canviodb", "root", "");
             stmt=conn.createStatement();

             
            System.out.println("gg");
            ResultSet resultSet2 = stmt.executeQuery("SELECT * FROM `consumption` WHERE month(dateTime) ='"+month+"';");
            consumpid = null;
            consumption = null;
        ...
        request.setAttribute("consumpid", consumpid);
